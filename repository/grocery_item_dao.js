...
function addGroceryItem(grocery_item_id, name, quantity, price, purchased) {
...
function updateGroceryNameById(grocery_item_id, name, price, purchased, quantity) {
    const params = {
        TableName: 'grocery_items',
        Key: {
            grocery_item_id
        },
        UpdateExpression: 'set #name = :name, #price = :price, #purchased = :purchased, #quantity = :quantity',
        ExpressionAttributeNames: {
            '#name': 'name',
            '#price': 'price',
            '#purchased': 'purchased',
